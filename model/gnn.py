...
# GNN implementations from MolCLR
...
def gcn_norm(edge_index, num_nodes=None):
    ...
    # Replace scatter_add with native PyTorch operations
...
class GCNConv(MessagePassing):
    ...
    def message_and_aggregate(self, adj_t, x):
        # Remove torch_sparse dependency - this method is not used in the current implementation
        # If needed, it can be implemented using standard PyTorch operations
        raise NotImplementedError("This method requires torch_sparse. Use the standard message passing instead.")
